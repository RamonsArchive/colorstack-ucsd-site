...
const SkinnyCard = ({ card }: { card: StaticCardType }) => {
  ...
  return (
    <div className="flex flex-col items-center gap-3 bg-bg-secondary p-8 rounded-4xl shadow-lg border border-border-medium active:border-white hover:border-white hover:shadow-xl transition-all duration-300 cursor-pointer">
