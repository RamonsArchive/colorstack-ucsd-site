    ...
    data: [
      {
        id: "instagram",
        name: "Instagram",
        href: "https://www.instagram.com/colorstacksd",
      },
      {
        id: "discord",
        name: "Discord",
...
export const footerIcons = (id: string) => {
  return smallerIcons[id] || null;
};

const smallerIcons: Record<string, React.ReactElement> = {
  instagram: (
    <svg
